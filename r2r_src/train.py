...
from utils import read_vocab,write_vocab,build_vocab,Tokenizer,padding_idx,timeSince, read_img_features, ReDirectSTD, HiddenPrints
import utils
...
from eval_utils.COCOEvalCap import COCOEvalCap
...
ReDirectSTD(os.path.join(log_dir, 'log.txt'), 'stdout', False)
    ...
    for idx in range(0, n_iters, log_every):
        ...
        for env_name, (env, evaluator) in val_envs.items():
            ...
            if scores[env_name]['SPICE'] > best_spice[env_name]:
                ...
                #speaker.save(idx, os.path.join(log_dir, 'state_dict', 'best_%s_spice' % env_name))
