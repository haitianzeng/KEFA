...
class PanoFeaturesReader_my_v2:
    ...
    def __getitem__(self, key):
        ...
        return features, probs[:, 1:]  # drop the first number of 1601, the rest 1600 are class probs


if __name__ == '__main__':
    features_reader = PanoFeaturesReader_my_v2(
    ...
    feat, probs = features_reader[test_key]
    print(feat.shape)
    print(type(feat))
